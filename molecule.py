...
def atomset(a, element, x, y, z):
    return _molecule.atomset(a, element, x, y, z)
atomset = _molecule.atomset

def atomget(a, element, x, y, z):
    return _molecule.atomget(a, element, x, y, z)
atomget = _molecule.atomget

def bondset(b, a1, a2, atoms, epairs):
    return _molecule.bondset(b, a1, a2, atoms, epairs)
bondset = _molecule.bondset

def bondget(b, a1, a2, atoms, epairs):
    return _molecule.bondget(b, a1, a2, atoms, epairs)
bondget = _molecule.bondget

def compute_coords(b):
    return _molecule.compute_coords(b)
compute_coords = _molecule.compute_coords

def bond_comp(b1, b2):
    return _molecule.bond_comp(b1, b2)
...
def molappend_atom(mol, newAtom):
    return _molecule.molappend_atom(mol, newAtom)
molappend_atom = _molecule.molappend_atom

def molappend_bond(mol, newBond):
    return _molecule.molappend_bond(mol, newBond)
molappend_bond = _molecule.molappend_bond

def molsort(mol):
    return _molecule.molsort(mol)
molsort = _molecule.molsort

def xrotation(matrix, deg):
    return _molecule.xrotation(matrix, deg)
xrotation = _molecule.xrotation

def yrotation(matrix, deg):
    return _molecule.yrotation(matrix, deg)
yrotation = _molecule.yrotation

def zrotation(matrix, deg):
    return _molecule.zrotation(matrix, deg)
zrotation = _molecule.zrotation

def mol_xform(mol, matrix):
    return _molecule.mol_xform(mol, matrix)
...
def rotationsfree(rot):
    return _molecule.rotationsfree(rot)
rotationsfree = _molecule.rotationsfree

def atom_comp(a1, a2):
    return _molecule.atom_comp(a1, a2)
atom_comp = _molecule.atom_comp

def average(val1, val2):
    return _molecule.average(val1, val2)
average = _molecule.average

def distance(x1, x2, y1, y2):
    return _molecule.distance(x1, x2, y1, y2)
distance = _molecule.distance
